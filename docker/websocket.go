...
func statsWebsocketHandler(w http.ResponseWriter, r *http.Request, containerID []byte) {
    ...
    for {
        ...
        default:
            ...
            if err != nil && websocket.IsUnexpectedCloseError(err, websocket.CloseNormalClosure, websocket.CloseGoingAway, websocket.CloseNoStatusReceived, websocket.CloseAbnormalClosure){
