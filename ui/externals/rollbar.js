...
export default function(accessToken, environment) {
  ...
  !(function(r) {
    ...
    function(r, e, o) {
      ...
      (_rollbarConfig = _rollbarConfig || {}),
        (_rollbarConfig.rollbarJsUrl =
          _rollbarConfig.rollbarJsUrl ||
          'https://cdnjs.cloudflare.com/ajax/libs/rollbar.js/2.4.2/rollbar.min.js'),
    ...
    function(r, e, o) {
        ...
        if (r) {
          ...
          return n(function() {
            e.captureUncaught &&
              ...
              s.captureUncaughtExceptions(r, t, !0),
              s.wrapGlobals(r, t, !0)),
              e.captureUnhandledRejections && s.captureUnhandledRejections(r, t, !0);
      ...
      (i = c.curry ? c.curry(p) : c.bind(null, p)),
